<meta charset="UTF-8">
        ...
        <!--Favicon links-->
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/img/svg/jardiCare.png') }}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/svg/jardiCare.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/img/svg/jardiCare.png') }}">
